...
danmu.prototype.x=function(){
	return this.left;
};
danmu.prototype.width=function(){
	return this.dom.width();
};
danmu.prototype.canDes=function(){
...
danmu.prototype.creatui=function(){
...
//			$('#'+this._divId)
		...
		setValue2:function(txt){
			let txt2=new danmu(txt,_this.locTemp.index);
